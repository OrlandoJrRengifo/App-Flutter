...
import 'features/groups/data/datasources/i_group_datasource.dart';
import 'features/groups/data/datasources/group_sqflite_datasource.dart';
import 'features/groups/data/repositories/group_repository.dart';
import 'features/groups/presentation/controller/group_controller.dart';
...
void main() async {
  ...
  // ==================== Grupos ====================
  Get.lazyPut<IGroupDataSource>(() => GroupSqfliteDataSource(), fenix: true);
  Get.lazyPut<IGroupRepository>(() => GroupRepository(Get.find()), fenix: true);
  Get.lazyPut(() => GroupUseCase(Get.find()), fenix: true);
